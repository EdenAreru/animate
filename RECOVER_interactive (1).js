...
lib.ssMetadata = [
		{name:"RECOVER_interactive _1__atlas_", frames: [[0,0,1920,1200],[3432,2806,626,626],[2564,3313,637,384],[2315,2284,970,545],[1922,0,1791,1190],[3287,2284,798,520],[0,3820,1847,167],[0,2216,1287,880],[0,3098,1280,720],[1922,1192,1831,1090],[1282,3098,1280,720],[1289,2284,1024,768],[2564,3699,520,293],[0,1202,1579,1012],[2564,2831,866,480],[3203,3434,601,370]]}
];
...
(lib.accelworld = function() {
	this.spriteSheet = ss["RECOVER_interactive _1__atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.RECOVER_interactive1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/RECOVER_interactive _1__atlas_.png?1529915655152", id:"RECOVER_interactive _1__atlas_"}
	],
	preloads: []
};
